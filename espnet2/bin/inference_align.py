...
LastEditTime: 2024-05-16 09:00:18
...
if __name__ == '__main__':
    ...
    all_files = []
    for scene in scenes:
        for root, dirs, files in os.walk(f'/data/home/RealisticAudio/codes/4_target_gen/aligned_static_low_粗略对齐_correctDPRIR/{scene}'):
            for index, file in enumerate(files):

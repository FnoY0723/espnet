...
class DefaultFrontend(AbsFrontend):
    ...
    def __init__(
        ...
        # self.base_mels_path = "/data/home/fangying/sn_enh_mel/CHIME_real_new_reverb+0.15_wo_reverb/eps_78/"

        self.base_mels_path = "/data/home/fangying/sn_enh_mel/REVERB_simu+real_new_eps78/simu"
    ...
    def forward(
        ...
        # name = name[2:-2]
        # mel = np.load(os.path.join(self.base_mels_path, name + '.npy'))
        # mel_tensor = torch.from_numpy(mel).to(input_feats.device).permute(1,2,0)
        # logging.info("mel_tensor: " + str(mel_tensor))
        # mean = mel_tensor.sum(dim=1, keepdim=True).squeeze() / mel_tensor.size(1)
        # logging.info("Mean mel_tensor: " + str(mean))

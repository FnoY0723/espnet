...
class DefaultFrontend(AbsFrontend):
    ...
    def __init__(
        ...
        self.base_mels_path = "/data/home/fangying/sn_enh_mel/mels/4xSPB_Hid96_offline_L1_1e-5_RTS_ensemble89-99"
    ...
    def forward(
        ...
        if 'CHIME' in self.base_mels_path:
            if 'REAL' in name:
                if 'real' not in self.base_mels_path:
                ...
                if 'simu' not in self.base_mels_path:
        ...
        if 'REVERB' in self.base_mels_path:
            if 'Real' in name and 'real' not in self.base_mels_path:
                self.base_mels_path = os.path.join(self.base_mels_path, 'real')
            elif 'Sim' in name and 'simu' not in self.base_mels_path:
                self.base_mels_path = os.path.join(self.base_mels_path,'simu')
